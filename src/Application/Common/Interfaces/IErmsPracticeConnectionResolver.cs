...
/// <summary>
/// ERMS's connection routing, now backed by the central tenant registry (ADR-001) instead of the
/// old flat per-practice `Erms:DbCredentials:ConnIndiciDB{practiceSuffix}` secret convention. The
