...
/// <summary>
/// KARO/HSS DMS connection routing. Real legacy Web.config confirms the DMS connection (e.g.
...
/// <see cref="IKaroPracticeConnectionResolver"/> and only swaps the database name, instead of requiring
/// its own separate per-practice secret to be configured.
/// </summary>
