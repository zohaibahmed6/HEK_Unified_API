...
namespace Hiso
{
    public class PatientBuilder
    {
        ...
        public DataTable GenerateTable(XmlDocument xDoc, HealthLinkSession objSession)
        {
            ...
            string[] strColumns = Utitlity.GetColumnNameByTableName("UDT_tblPatient");
            ...
            if (objSession.ReferenceId > 0)
            {
                ...
                dr["ReferenceId"] = objSession.PatientId;
            }
        ...
        public bool Save(DataTable dtPatient, HealthLinkSession objSession) {
            ...
            try
            {
                ...
                cmd.CommandText = "[Hiso].[uspPatient_Update]";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@tblPatient", dtPatient));
