...
namespace Hiso
{
    public class PatientConsultBuilder
    {
        public DataTable GenerateTable(XmlDocument xDoc, HealthLinkSession objSession)
        {
            DataTable dtPatient = new DataTable();
            string[] strColumns = Utitlity.GetColumnNameByTableName("UDT_tblPatientConsult");
            ...
            {
                dr["ReferenceId"] = objSession.AppointmentId;
            }
        ...
        public bool Save(DataTable dtPatient, HealthLinkSession objSession)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[Hiso].[uspPatientConsult_Update]";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@tblPatientConsult", dtPatient));
